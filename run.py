...
if __name__ == '__main__':
    ...
    try:
        ...
        if not public_utils.have_internet():
            ...
            subprocess.call([sys.executable, "-m", "pip", "install", '-r', 'src/agent/requirements.txt'])
        ...
        subprocess.call([sys.executable, "-m", "pip", "install", '-r', 'src/agent/requirements.txt', '--upgrade', '--upgrade-strategy=eager'])
